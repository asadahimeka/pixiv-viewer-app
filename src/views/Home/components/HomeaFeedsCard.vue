...
export default {
  ...
  data() {
    return {
      ...
      swiperOption: {
        ...
        navigation: {
          nextEl: '.HomeaFeedsCard .swiper-button-next',
          prevEl: '.HomeaFeedsCard .swiper-button-prev',
        },
      },
    }
  },
  ...
  methods: {
    async getRankList() {
      this.loading = true
      const res = await localApi.illustFollow()
      if (res.status === 0) {
