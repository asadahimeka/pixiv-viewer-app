<template>
  <div class="setting-page">
    ...
    <van-cell-group :title="$t('9X179hdP1zzapzk5Rvqx2')">
      ...
      <van-cell v-if="!isMobile && !isNavSHSetShow" center :title="$t('mR4YFHYUnr00zmzYydrMv')" :label="$t('V-KoSeNoEiNct7oZJgCcD')">
        <template #right-icon>
    ...
    <van-cell-group :title="$t('6oe7JPS26HGAlcjQdmHZ4')">
      ...
      <van-cell v-if="showPIDMaskSetting" center :title="$t('lGla4o1MNG0QBOBr2K2DK')">
        <template #right-icon>
